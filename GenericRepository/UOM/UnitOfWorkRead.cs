...
namespace Base.DataAccess.GenericRepository.UOM
{
    ...
    public class UnitOfWorkRead<TContext> : IRepositoryFactory, IUnitOfWorkRead where TContext : DbContext
    {
        ...
        public UnitOfWorkRead(TContext context, IHttpContextAccessor httpContextAccessor, IContextHelper contextHelper)
        {
